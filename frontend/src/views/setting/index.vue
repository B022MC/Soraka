          ...
          <a-row :gutter="16">
            ...
            <a-col :span="12">
              <a-form-item field="Reload" label="重置窗口">
                <a-button type="primary" @click="()=>Window.Reload()" size="small">
                  <template #icon>
                    <icon-translate />
                  </template>
            ...
            <a-col :span="12">
              <a-form-item field="OpenDevTools" label="打开调试工具">
                <a-button type="primary" @click="()=>Window.OpenDevTools()" size="small">
                  <template #icon>
                    <icon-launch />
                  </template>
...
<script lang="ts" setup>
  ...
  const handleTheme=async()=>{
    ...
    if(formData.value.theme=="dark"){
      isdark=true
    }else if(formData.value.theme=="auto"){//自动
...
<style scoped lang="less">
  .container {
    ...
    .card{
      ...
      box-shadow: 0 10px 11px rgb(var(--arcoblue-3),0.08),0 6px 4px rgb(var(--arcoblue-3),0.06),0 0 0 1px rgb(var(--arcoblue-3),0.05),
